...
def main() -> None:
    ...
    p = argparse.ArgumentParser(
        description="Run frame extraction, human detection, then motion ROI crops."
    )
    p.add_argument(
        "--skip-extraction",
        action="store_true",
    ...
    if not args.skip_extraction:
        ...
        print("=== Step 1/3: Frame extraction ===")
    ...
    if not args.skip_roi:
        ...
        print("=== Step 3/3: skipped (--skip-roi) ===")
